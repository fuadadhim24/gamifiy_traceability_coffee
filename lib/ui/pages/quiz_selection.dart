  ...
  void _showUsernameDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('Masukkan Username', style: TextStyle(fontWeight: FontWeight.bold)),
        content: TextField(
          ...
          TextButton(
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => QuizSelectionListPage(username: username),
                ),
              );
            },
            child: const Text('OK', style: TextStyle(color: Colors.green, fontSize: 16.0)),
          ),
        ],
      ),
    );
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          ...
          child: const Text('Mulai', style: TextStyle(color: Colors.white,fontSize: 18.0)),
        ),
      ),
    );
  }
...
class QuizSelectionListPage extends StatelessWidget {
  ...
  const QuizSelectionListPage({required this.username, Key? key}) : super(key: key);
